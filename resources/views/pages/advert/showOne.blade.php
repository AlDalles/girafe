    ...
    <div class="main">
        <div class="main__ad">
            ...
            <div class="main__ad__title">
                ...
                @can('delete',$advert)
                    <form action="/delete/{{$advert->id}}" class="main__ad__title__form" method="post">@csrf
            ...
            <div>
                <div class="main__ad__image">
                    <img src="{{asset($advert->image_patch)}}" alt="Image Ad" class="main__ad__image__inner">
                    <!--в src это путь к картинке-->
                </div>
