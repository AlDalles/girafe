                ...
                <form action="/" class="create__ad" method="post" enctype="multipart/form-data">
                    @else
                        ...
                        <form action="/edit/{{$advert->id}}" class="create__ad" method="post">
                            ...
                            <input type="file" id="image_patch" name="image_patch" class="create__ad__input"
                                   placeholder="Image">
                            ...
                            <input name="title" type="text" id="titel" class="create__ad__input" placeholder="Title"
                            ...
                            <textarea name="description" id="description" cols="30" rows="10"
                                      placeholder="Description">{{old('description') ?? $advert->description}}</textarea>
                            ...
                            <div class="create__ad__button">
                                <input type="submit" value="{{$value}}" class="create__ad__button__submit">
                                <!--тут для редактирования поменять value="Create" на value="Save"-->
                            </div>
                        </form>
        </div>
    </div>
